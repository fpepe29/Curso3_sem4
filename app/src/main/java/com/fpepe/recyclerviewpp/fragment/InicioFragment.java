package com.fpepe.recyclerviewpp.fragment;
...
import com.fpepe.recyclerviewpp.R;
import com.fpepe.recyclerviewpp.interfaces.IComunicaFragments;
...
public class InicioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardUser=vista.findViewById(R.id.cardJugador);
        cardInfo=vista.findViewById(R.id.cardAcercade);
    ...
    private void eventosMenu() {
        ...
        cardInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                interfaceComunicaFragments.consultarInformación();
            }
        });
