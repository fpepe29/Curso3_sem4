package com.fpepe.recyclerviewpp;
...
import com.fpepe.recyclerviewpp.fragment.InicioFragment;
...
public class MainActivity extends AppCompatActivity implements IComunicaFragments, InicioFragment.OnFragmentInteractionListener {
    ...
    public void consultarRanking() {
        Toast.makeText(getApplicationContext(), "Iniciando Jack Russell", Toast.LENGTH_SHORT).show();
    }
